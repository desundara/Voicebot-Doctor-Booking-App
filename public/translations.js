...
const PROMPTS = {
  ...
  smallTalkGreetingReply: { en: "Hi there! 👋", si: "ආයුබෝවන්! 👋", fr: "Bonjour ! 👋", zh: "你好！👋", el: "Γειά σας! 👋", it: "Ciao! 👋" },
  smallTalkThanksReply: { en: "You're welcome! 😊", si: "ඕන දෙයක් නෑ! 😊", fr: "Je vous en prie ! 😊", zh: "不客气！😊", el: "Παρακαλώ! 😊", it: "Prego! 😊" },
  smallTalkHelpReply: { en: "I can help you book a doctor's appointment, Monday to Friday. Just type what you need in your own words, or use the buttons below.", si: "මට ඔබට සඳුදා සිට සිකුරාදා දක්වා වෛද්‍ය appointment එකක් වෙන් කරගන්න උදව් කරන්න පුළුවන්. ඔබට අවශ්‍ය දේ ඔබේම වචන වලින් type කරන්න, නැත්නම් පහත buttons පාවිච්චි කරන්න.", fr: "Je peux vous aider à prendre rendez-vous avec un médecin, du lundi au vendredi. Écrivez ce dont vous avez besoin avec vos propres mots, ou utilisez les boutons ci-dessous.", zh: "我可以帮您预约医生，周一至周五。请用您自己的话告诉我您的需求，或使用下方的按钮。", el: "Μπορώ να σας βοηθήσω να κλείσετε ραντεβού με γιατρό, Δευτέρα έως Παρασκευή. Γράψτε με δικά σας λόγια τι χρειάζεστε, ή χρησιμοποιήστε τα κουμπιά παρακάτω.", it: "Posso aiutarti a prenotare un appuntamento con un medico, dal lunedì al venerdì. Scrivi con parole tue cosa ti serve, oppure usa i pulsanti qui sotto." },
};
